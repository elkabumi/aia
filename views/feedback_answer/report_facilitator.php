...
<div class="preview_title">EVALUASI FORM FEED BACK TRAINER 
</div>
...
<table width="100%" class="table table-bordered" style="border-right:1px solid #eee;">
                                        <thead>
                                            <tr>
...
<br />
 ...
 <a href="feedback_answer.php?page=download_fac&id=<?= $_GET['id']?>" class="btn btn-danger" >Download</a>
</div>
</div>
</form>
</div>
