                                           ...
                                           $no_item = 1;
                                            ...
                                            <td><?= $no_item ?></td>
                                                ...
                                                <td style="text-align:center;">
                                                    <a href="logistic.php?page=form&id_item=<?= $row_item['logistic_item_id']?>" class="btn btn-danger" ><i class="fa fa-pencil"></i></a>
                                                <a href="javascript:void(0)" onclick="confirm_delete(<?= $row_item['logistic_item_id']; ?>,'logistic.php?page=delete_item&id=')" class="btn btn-danger" ><i class="fa fa-trash-o"></i></a></td>
                                            </tr>
                                            <?php
											$no_item++;
                                            }
