                                ...
                                <div class="box-body">
                                        ...
                                        <!-- text input -->
                                         <div class="form-group">
                                            ...
                                            <input required type="text" name="event_name" class="form-control" placeholder="Enter ..." value="<?= $row->transaction_name ?>" readonly="readonly"/>
                                        </div>
                                    ...
                                    <div class="bootstrap-timepicker">
                                         <div class="form-group">
                                           ...
                                           <div class="bootstrap-timepicker">
                                         <div class="form-group">
                                            <label>Event end Hour</label>
                                            <input required type="text" name="event_hour2" class="form-control timepicker" placeholder="Enter ..." value="<?= $row->transaction_hour2 ?>"/>
                                        </div>
                                	</div>
