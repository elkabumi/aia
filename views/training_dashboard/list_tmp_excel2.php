                                        ...
                                        <tbody>
                                            ...
                                            <td><?= $no?></td>
                                                ...
                                                <td style="text-align:center;">
                                                 <a href="javascript:void(0)" onclick="confirm_delete(<?= $row['0']; ?>,'training_dashboard.php?page=delete_agent_tmp_event2&id=<?=$id?>&agent_id_tmp_event=')" class="btn btn-danger" ><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            </tr>
                                            <?php
