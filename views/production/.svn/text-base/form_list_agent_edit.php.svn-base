...
<select class="form-control" name="i_month">
										...
										?>
                                        <option value="<?= $i_m ?>" <?php if($i_m == $data_production->production_month){ ?>selected="selected" <?php } ?>><?= $month[$i_m] ?></option>
                                        <?php
                                        }
                                        ?>
                                        </select>
...
<select class="form-control" name="i_year">
										...
										?>
                                        <option value="<?= $i_y ?>" <?php if($i_y == $data_production->production_year){ ?>selected="selected" <?php } ?>><?= $i_y ?></option>
                                        <?php
                                        }
                                        ?>
                                        </select>
                                        ...
                                        <tbody>
                                           ...
                                           $no = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="i_value<?= $no?>" id="i_value<?= $no?>"  required value="<?= $row_agent['production_value']?>"/></td>
                                          </tr>
                                               <?php
											$no++;
                                            }
